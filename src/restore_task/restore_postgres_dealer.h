...
namespace kunlun {
class PostGresRestoreDealer : public RequestDealer {
  typedef RequestDealer super;

public:
  explicit PostGresRestoreDealer(const char *request_json_str)
      : super(request_json_str) {}

  virtual ~PostGresRestoreDealer() {}
