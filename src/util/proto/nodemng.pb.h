...
#ifndef PROTOBUF_nodemng_2eproto__INCLUDED
#define PROTOBUF_nodemng_2eproto__INCLUDED
...
class HttpRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kunlunrpc.HttpRequest) */ {
 ...
 private:
  ...
  friend struct ::protobuf_nodemng_2eproto::TableStruct;
  friend void ::protobuf_nodemng_2eproto::InitDefaultsHttpRequestImpl();
};
// -------------------------------------------------------------------
...
class HttpResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kunlunrpc.HttpResponse) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_nodemng_2eproto::TableStruct;
  friend void ::protobuf_nodemng_2eproto::InitDefaultsHttpResponseImpl();
};
// ===================================================================
...
class HttpService : public ::google::protobuf::Service {
 ...
 public:
  ...
  virtual void Shell(::google::protobuf::RpcController* controller,
                       const ::kunlunrpc::HttpRequest* request,
                       ::kunlunrpc::HttpResponse* response,
                       ::google::protobuf::Closure* done);
...
class HttpService_Stub : public HttpService {
 public:
  ...
  void Emit(::google::protobuf::RpcController* controller,
                       ...
                       ::kunlunrpc::HttpResponse* response,
                       ::google::protobuf::Closure* done);
  void Shell(::google::protobuf::RpcController* controller,
                       const ::kunlunrpc::HttpRequest* request,
                       ::kunlunrpc::HttpResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
#endif  // PROTOBUF_nodemng_2eproto__INCLUDED
