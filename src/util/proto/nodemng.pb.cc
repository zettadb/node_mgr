...
// source: nodemng.proto

#include "nodemng.pb.h"
...
namespace protobuf_nodemng_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "nodemng.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "t\"\016\n\014HttpResponse2\200\001\n\013HttpService\0227\n\004Emi"
      "t\022\026.kunlunrpc.HttpRequest\032\027.kunlunrpc.Ht"
      "tpResponse\0228\n\005Shell\022\026.kunlunrpc.HttpRequ"
      "est\032\027.kunlunrpc.HttpResponse2P\n\013FileServ"
      "ice\022A\n\016default_method\022\026.kunlunrpc.HttpRe"
      "quest\032\027.kunlunrpc.HttpResponseB\003\200\001\001"
  };
...
HttpRequest::HttpRequest()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_nodemng_2eproto::InitDefaultsHttpRequest();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* HttpRequest::descriptor() {
  ...
  return ::protobuf_nodemng_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata HttpRequest::GetMetadata() const {
  protobuf_nodemng_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_nodemng_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
HttpResponse::HttpResponse()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_nodemng_2eproto::InitDefaultsHttpResponse();
  }
  SharedCtor();
...
const ::google::protobuf::ServiceDescriptor* HttpService::descriptor() {
  protobuf_nodemng_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_nodemng_2eproto::file_level_service_descriptors[0];
}
...
void HttpService::Shell(::google::protobuf::RpcController* controller,
                         const ::kunlunrpc::HttpRequest*,
                         ::kunlunrpc::HttpResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method Shell() not implemented.");
  done->Run();
}
...
void HttpService::CallMethod(const ::google::protobuf::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), protobuf_nodemng_2eproto::file_level_service_descriptors[0]);
  switch(method->index()) {
    case 0:
      Emit(controller,
...
void HttpService_Stub::Shell(::google::protobuf::RpcController* controller,
                              const ::kunlunrpc::HttpRequest* request,
                              ::kunlunrpc::HttpResponse* response,
                              ::google::protobuf::Closure* done) {
